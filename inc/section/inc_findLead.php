<?php
	...
	if(is_front_page() || is_home()){
        $content_post = get_post($int_setting_ids['top']);
		$title = get_post_meta($int_setting_ids['top'],'cf_top_title',true);
	...
	if( !$title )$title = get_post_meta($int_setting_ids['top'],'cf_top_title',true);
?>

        ...
        <form action="<?php echo esc_url( get_home_url() ); ?>/word-mouth/" method="get">
            <div class="pulldown">
                <select name="wm" class="selecting" id="jsAutoSubmit">
                    <option value=""><?php echo $product_name; ?>で絞り込み</option>
                ...
                <?php while ( $my_query->have_posts() ) : $my_query->the_post(); ?>
                    ...
                    <li class="listWordMouth__item">
                        <div class="listWordMouth__label">
                            ...
                            <div class="listWordMouth__reputation"><?php view_reputation_common($wordmouth_reputation,'listWordMouth__reputation',3); ?></div>
                        </div>
